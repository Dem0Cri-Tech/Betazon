...
namespace Betazon.Migrations
{
    ...
    [Migration("20221212141701_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Betazon.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.Credentials", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Betazon.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("Betazon.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betazon.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betazon.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("Betazon.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betazon.Models.UserLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Betazon.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("Betazon.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("Betazon.Models.Credentials", b =>
                {
                    b.HasOne("Betazon.Models.Customer", "customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Betazon.Models.CustomerAddress", b =>
                {
                    b.HasOne("Betazon.Models.Address", "Address")
            ...
            modelBuilder.Entity("Betazon.Models.Product", b =>
                {
                    b.HasOne("Betazon.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("Betazon.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Betazon.Models.ProductCategory", b =>
                {
                    b.HasOne("Betazon.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("Betazon.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("Betazon.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("Betazon.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("Betazon.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("Betazon.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("Betazon.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("Betazon.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("Betazon.Models.Address", "ShipToAddress")
            ...
            modelBuilder.Entity("Betazon.Models.UserLog", b =>
                {
                    b.HasOne("Betazon.Models.Credentials", "user")
                        .WithMany("UserLogs")
